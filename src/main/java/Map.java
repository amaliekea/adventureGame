public class Map {
    ...
    public Map() {
        ...
        room1.addEnemy(new Enemy("a tall, slender and slimy alien", "alien", 150, new MeleeWeapon("long tentacles with poisonous spikes", "tentacles", 20)));
        room5.addEnemy(new Enemy("a tiny, furry and purple animal", "animal", 100, new MeleeWeapon("long, razor sharp claws", "claws", 20)));
